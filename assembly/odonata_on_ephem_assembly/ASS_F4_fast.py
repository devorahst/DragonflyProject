# cript was written by Jesse Breinholt (jessebreinholt@gmail.com)
...
if findprobehitblast:
	...
	# print("used blast to find probe locations in the genome use "+taxaname+"probehits_out as -inpc")
